...
def structure_data_with_master_prompt(raw_text, base64_images):
    ...
    """
    # <<< THE CHANGE IS HERE: Added "address" to Emirates ID and Generic templates >>>
    prompt = f"""
...
def process_documents_task(self, file_contents_dict, doc_type):
    ...
    try:
        ...
        # We save with the user-selected type, but the AI's classification is inside the JSON
